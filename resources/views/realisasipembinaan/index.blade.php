                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_realisasi" name="tanggal_realisasi" required
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            if (kegiatanId) {
                $.get(`${BASE_URL}/realisasipembinaan/kegiatan/${kegiatanId}/summary`)
                    .done(function(resp) {
                        if (resp?.success) {
                            const {
                                total_pagu,
                ...
                $.get(`${BASE_URL}/realisasipembinaan/kegiatan/${kegiatanId}/sub_kegiatan`)
                    .done(function(resp) {
                        if (resp?.success) {
            ...
            $('#f_sub').on('select2:select select2:clear', function(e) {
                ...
                if (e.type === 'select2:select' && $opt.length) {
                    ...
                    $.get(`${BASE_URL}/realisasipembinaan/sub_kegiatan/${subId}/rekening`)
                        .done(function(resp) {
                            if (resp?.success) {
            ...
            $('#f_rekening').on('select2:select select2:clear', function(e) {
                ...
                if (e.type === 'select2:select' && $opt.length) {
                    ...
                    $.get(`${BASE_URL}/realisasipembinaan/rekening/${rekeningId}/ssh`)
                        .done(function(resp) {
                            if (resp?.success) {
                            ...
                            if (res?.status) {
                                Swal.fire({
                                    ...
                                    .then(() => {
                                        ...
                                        if (sshId) {
                                            $.get(`${BASE_URL}/realisasipembinaan/ssh/${sshId}/summary`, {
                                                    _: Date.now()
                                                })
                                                .done(function(resp) {
                                                    if (resp?.success) {
        ...
        `);
                ...
                historiTable = $('#tbl-histori').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: `${BASE_URL}/realisasipembinaan/ssh/${sshId}/histori`,
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
